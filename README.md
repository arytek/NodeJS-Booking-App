...
<ol>
  ...
  <li>You will be asked if you would like to initialise the Google Calendar instance with fresh timeslots. Enter 'y' (yes) if you are running this app for the first time.</li>
